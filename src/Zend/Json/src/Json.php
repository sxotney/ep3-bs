...
class Json
{
     ...
     * objects. See {@link Laminas\Json\Decoder::decode()} for details.
     * @return mixed
    ...
    public static function encode($valueToEncode, $cycleCheck = false, $options = [])
    {
        ...
        // Pre-encoding look for Laminas\Json\Expr objects and replacing by tmp ids
        ...
        //only do post-processing to revert back the Laminas\Json\Expr if any.
    ...
    /**
     * Check & Replace Laminas\Json\Expr for tmp ids in the valueToEncode
     *
     * Check if the value is a Laminas\Json\Expr, and if replace its value
     ...
     * the XML tags
     *
     * In order to allow Laminas\Json\Expr from xml, we check if the node
     * matches the pattern that try to detect if it is a new Laminas\Json\Expr
     * if it matches, we return a new Laminas\Json\Expr instead of a text node
     *
     ...
     *
     * NOTE: Encoding native javascript expressions via Laminas\Json\Expr is not possible.
     *
     * @static
     * @access public
    ...
    public static function fromXml($xmlStringContents, $ignoreXmlAttributes = true)
    {
        ...
        // Convert the PHP array to JSON using Laminas\Json\Json encode method.
